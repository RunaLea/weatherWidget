<template>
  <div v-if="currentWeather" class="card bg-gradient-to-br from-white/30 to-gray-100/30 rounded-2xl shadow-xl p-8 w-full max-w-md mx-auto mb-6 text-black flex flex-col items-center">
